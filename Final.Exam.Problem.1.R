## Attached is a file nonlinear_least_squares.txt containing 1000 data points (x,y)

## Part A -- 
## Assume the model y ~ d exp(-r*x), where exp is the exponential e. Use a modified Newton's method
## to minimize the least squares function: ...
## You will have to write R functions for teh gradient and Hessian of L(d,r). Plot the fitted curve d exp[-r*x]
## and the data points. Does the fit look good
...
## Part B
## Use the R function nls to fit the model. Compare your answer in Part A
